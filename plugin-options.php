<?php
  ...
  $config = array(    
    ...
    'page_title'     => __('Wordpress Image Toolkit', WP_IMAGE_TOOLKIT_TEXTDOMAIN),       //The name of this page 
  ...
  $options_panel->TabsListing(array(
    'links' => array(
      'options_1' =>  __('Adaptive Images',WP_IMAGE_TOOLKIT_TEXTDOMAIN),
      'options_2' =>  __('Retina Images',WP_IMAGE_TOOLKIT_TEXTDOMAIN),
      'options_3' =>  __('Grayscale Images',WP_IMAGE_TOOLKIT_TEXTDOMAIN),
      'options_4' =>  __('Import Export',WP_IMAGE_TOOLKIT_TEXTDOMAIN),
    )
  ));
  ...
  $options_panel->addParagraph(__('These settings apply to images that are bigger than actual screen size.',WP_IMAGE_TOOLKIT_TEXTDOMAIN));
  ...
  //textarea field
  $options_panel->addTextarea('textarea_field_id',array('name'=> __('My Textarea ',WP_IMAGE_TOOLKIT_TEXTDOMAIN), 'std'=> 'textarea', 'desc' => __('Simple textarea field description',WP_IMAGE_TOOLKIT_TEXTDOMAIN)));
  //checkbox field
  $options_panel->addCheckbox('checkbox_field_id',array('name'=> __('My Checkbox ',WP_IMAGE_TOOLKIT_TEXTDOMAIN), 'std' => true, 'desc' => __('Simple checkbox field description',WP_IMAGE_TOOLKIT_TEXTDOMAIN)));
  //select field
  $options_panel->addSelect('select_field_id',array('selectkey1'=>'Select Value1','selectkey2'=>'Select Value2'),array('name'=> __('My select ',WP_IMAGE_TOOLKIT_TEXTDOMAIN), 'std'=> array('selectkey2'), 'desc' => __('Simple select field description',WP_IMAGE_TOOLKIT_TEXTDOMAIN)));
  //radio field
  $options_panel->addRadio('radio_field_id',array('radiokey1'=>'Radio Value1','radiokey2'=>'Radio Value2'),array('name'=> __('My Radio Filed',WP_IMAGE_TOOLKIT_TEXTDOMAIN), 'std'=> array('radiokey2'), 'desc' => __('Simple radio field description',WP_IMAGE_TOOLKIT_TEXTDOMAIN)));
  /**
  ...
  $options_panel->addParagraph(__("These settings apply to images sizes that are declared in wordpress core, themes and plugins.",WP_IMAGE_TOOLKIT_TEXTDOMAIN));
  
  /**
   * Add fields to retina options tab
   */
  $options_panel->addCheckbox('enable_retina',array('name'=> __('Enable retina images support ',WP_IMAGE_TOOLKIT_TEXTDOMAIN), 'std' => false, 'desc' => __('Creates retina image sizes automatically, and ensures the good image is displayed automatically when calling the_post_thumbnail and derivatives.',WP_IMAGE_TOOLKIT_TEXTDOMAIN)));
  
  /*$retina_images_show_in_wordpress[] = $options_panel->addCheckbox('generate_images_from_retina_version',array('name'=> __('Generate standard images from retina version ',WP_IMAGE_TOOLKIT_TEXTDOMAIN), 'std' => false, 'desc' => __('Creates standard images sizes automatically, by downscaling 2x from retina images.',WP_IMAGE_TOOLKIT_TEXTDOMAIN)),true);
  
  //conditional block 
  $options_panel->addCondition('retina_images_show_in_wordpress',
      array(
        'name'   => __('Add retina images to wordpress sizes ',WP_IMAGE_TOOLKIT_TEXTDOMAIN),
        'desc'   => __('Useful when you use a plugin that allows you to manually crop images individually, so you have complete control over your images.<br>Perfectly coupled with <a href="http://wordpress.org/extend/plugins/post-thumbnail-editor/">post thumbnail editor</a>',WP_IMAGE_TOOLKIT_TEXTDOMAIN),
   ...
   * Add fields to retina options tab
   */
  $options_panel->addCheckbox('enable_grayscale',array('name'=> __('Enable grayscale images support ',WP_IMAGE_TOOLKIT_TEXTDOMAIN), 'std' => false, 'desc' => __('Creates grayscale images automatically, thex can be displayed by using [IMAGE_SIZE]-gray in the_post_thumbnail and derivatives.',WP_IMAGE_TOOLKIT_TEXTDOMAIN)));
  ...
  //title
  $options_panel->Title(__("Import Export",WP_IMAGE_TOOLKIT_TEXTDOMAIN));
