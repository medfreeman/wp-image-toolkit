...
$resolutions   = array(1920, 1382, 992, 768, 480); // the resolution break-points to use (screen widths, in pixels)
$cache_path    = "wordpress/wp-content/ai-cache"; // where to store the generated re-sized images. Specify from your document root!
$jpg_quality   = 70; // the quality of any generated JPGs on a scale of 0 to 100
$sharpen       = TRUE; // Shrinking images can blur details, perform a sharpen on re-scaled images?
$watch_cache   = FALSE; // check that the adapted image isn't stale (ensures updated source images are re-cached)
...
$requested_uri = preg_replace('/2013test\//', '', $requested_uri, 1);
$requested_uri = preg_replace('/2013\//', '', $requested_uri, 1);

$source_file    = $document_root . '/wordpress' . $requested_uri;
$resolution     = FALSE;
